config = {
    ...
    "DEFAULT" : {
        ...
        "global_pr_sig": f"\n[center][size=6][b]Personal Release[/b][/size][/center]", #personal realease signature
    ...
    "TRACKERS" : {
        ...
        "LDU" : {
            ...
            "anon_signature" : f"\n[center][url=https://github.com/z-ink/Upload-Assistant][img=40]https://i.ibb.co/n0jF73x/hacker.png[/img][/url][/center]", #Only used if "use_global_sigs" : False, AND your uploading as "anon" : True, or passing -a at upload
            ...
            "anon_pr_signature": f"\n[center][url=https://github.com/z-ink/Upload-Assistant][img=40]https://i.ibb.co/n0jF73x/hacker.png[/img][/url][/center]", #Only used if "use_global_sigs" : False, AND your uploading as "anon" : True, or passing -a with -pr at upload
            },   
        ...
        "ACM" :{
            ...
            "anon_signature" : f"\n[center][url=https://github.com/z-ink/Upload-Assistant][img=40]https://i.ibb.co/n0jF73x/hacker.png[/img][/url][/center]",          
            "pr_signature": f"\n [center]PERSONAL RELEASE[/center] \n[center][b]PLEASE SEED LDU FAMILY[/b][/center]\n[center][size=6][url=https://github.com/z-ink/Upload-Assistant]Upload Assistant(CvT Mod v0.4)[/url][/size][/center]",
            "anon_pr_signature": f"\n[center][url=https://github.com/z-ink/Upload-Assistant][img=40]https://i.ibb.co/n0jF73x/hacker.png[/img][/url][/center]",
